...
data class EncyclopediaToxicResponse(

	@field:SerializedName("success")
	val success: Boolean? = null,

	@field:SerializedName("type_of_waste")
	val typeOfWaste: TypeOfWasteToxic? = null
)

data class ExamplesItemToxic(
...
data class TypeOfWasteToxic(

	@field:SerializedName("examples")
	val examples: List<ExamplesItemToxic?>? = null,
